...
namespace UAVP.UAVPSet
{
    ...
    public class ParameterSets
    {
        ...
        public ParameterSetsStruc[] parameterForm1 = new ParameterSetsStruc[30];
        public ParameterSetsStruc[] parameterForm2 = new ParameterSetsStruc[30];
        // für PIC Register 1 und 2
        public ParameterSetsStruc[] parameterPic1 = new ParameterSetsStruc[30];
        public ParameterSetsStruc[] parameterPic2 = new ParameterSetsStruc[30];
        ...
        string[] kurzParameter = { "RP","RI","RD","RL","RIL",
                                    ...
                                    "\r\nGP","GI","GD","GL","GIL",
                                    "\r\nGK","IA","AU","LRL","LVZ",
                                    "\r\nLAA","LWG","LL","LWR","LWN","KRN","KO", "BD", "GPSD", "GPSS" };
                ...
                if (mainForm.tabControlParameter.SelectedIndex == 0) 
                {
                    switch (Convert.ToInt16(register.Command.Substring(8))) 
                    {
                        ...
                        case 29:
                            ...
                            mainForm.numericUpDownGPSD1.Value = Convert.ToInt16(register.Value);
                            feldUpdaten(mainForm.numericUpDownGPSD1, mainForm);
                            break;
                        case 30:
                            parameterForm1[29].Value = register.Value;
                            mainForm.numericUpDownGPSSmooth1.Value = Convert.ToInt16(register.Value);
                            feldUpdaten(mainForm.numericUpDownGPSSmooth1, mainForm);
                            break;
                    }
                } 
                else 
                {
                    switch (Convert.ToInt16(register.Command.Substring(9))) 
                    {
                        ...
                        case 29:
                            ...
                            mainForm.numericUpDownGPSD2.Value = Convert.ToInt16(register.Value);
                            feldUpdaten(mainForm.numericUpDownGPSD2, mainForm);
                            break;
                        case 30:
                            parameterForm2[29].Value = register.Value;
                            mainForm.numericUpDownGPSSmooth2.Value = Convert.ToInt16(register.Value);
                            feldUpdaten(mainForm.numericUpDownGPSSmooth2, mainForm);
                            break;
                    }
                }
            }
        ...
        { 
            ...
            if (mainForm.tabControlParameter.SelectedIndex == 0) 
            {
                ...
                mainForm.numericUpDownGPSD1.ForeColor = farbeElement;
                mainForm.numericUpDownGPSP1.ForeColor = farbeElement;
                mainForm.numericUpDownGPSSmooth1.ForeColor = farbeElement;
            } 
            else 
            {
                ...
                mainForm.numericUpDownGPSD2.ForeColor = farbeElement;
                mainForm.numericUpDownGPSP2.ForeColor = farbeElement;
                mainForm.numericUpDownGPSSmooth2.ForeColor = farbeElement;
            }
        }
