                ...
                if (mainForm.tabControlParameter.SelectedIndex == 0)
                {
                    switch (Convert.ToInt16(register.Command.Substring(8)))
                    {
                        case 1:
                            ...
                            if (testen == true && mainForm.rollProp1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollProp1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 2:
                            ...
                            if (testen == true && mainForm.rollInt1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollInt1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 3:
                            ...
                            if (testen == true && mainForm.rollDiff1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollDiff1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 4:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.rollLimit1NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.rollLimit1NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.rollLimit1NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.rollLimit1NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm1[3].Value = register.Value;
                        ...
                        case 5:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.rollIntLimit1NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.rollIntLimit1NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.rollIntLimit1NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.rollIntLimit1NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm1[4].Value = register.Value;
                        ...
                        case 6:
                            ...
                            if (testen == true && mainForm.nickProp1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickProp1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 7:
                            ...
                            if (testen == true && mainForm.nickInt1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickInt1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 8:
                            ...
                            if (testen == true && mainForm.nickDiff1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickDiff1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 9:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.nickLimit1NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.nickLimit1NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.nickLimit1NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.nickLimit1NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm1[8].Value = register.Value;
                        ...
                        case 10:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.nickIntLimit1NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.nickIntLimit1NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.nickIntLimit1NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.nickIntLimit1NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm1[9].Value = register.Value;
                        ...
                        case 11:
                            ...
                            if (testen == true && mainForm.gierProp1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierProp1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 12:
                            ...
                            if (testen == true && mainForm.gierInt1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierInt1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 13:
                            ...
                            if (testen == true && mainForm.gierDiff1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierDiff1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 14:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.gierLimit1NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.gierLimit1NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.gierLimit1NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.gierLimit1NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm1[13].Value = register.Value;
                        ...
                        case 15:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.gierIntLimit1NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.gierIntLimit1NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.gierIntLimit1NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.gierIntLimit1NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm1[14].Value = register.Value;
                        ...
                        case 16:
                            ...
                            {
                                mainForm.bit01CheckBox.ForeColor = Color.Red;
                                mainForm.bit11CheckBox.ForeColor = Color.Red;
                                mainForm.bit21CheckBox.ForeColor = Color.Red;
                                mainForm.bit31CheckBox.ForeColor = Color.Red;
                                mainForm.bit41CheckBox.ForeColor = Color.Red;
                            }
                            parameterForm1[15].Value = register.Value;
                            break;
                        case 17:
                            mainForm.impulseAusgabe1NumericUpDown.ForeColor = farbeElement;
                            if (testen == true && mainForm.impulseAusgabe1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.impulseAusgabe1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 18:
                            ...
                            if (testen == true && mainForm.akku1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.akku1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 19:
                            ...
                            if (testen == true && mainForm.rollMa1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollMa1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 20:
                            ...
                            if (testen == true && mainForm.nickMa1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickMa1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 21:
                            ...
                            if (testen == true && mainForm.gierMa1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierMa1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 22:
                            ...
                            if (testen == true && mainForm.gierA1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierA1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 23:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.leerlaufgas1NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.leerlaufgas1NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.leerlaufgas1NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.leerlaufgas1NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm1[22].Value = register.Value;
                        ...
                        case 24:
                            ...
                            if (testen == true && mainForm.rollA1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollA1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 25:
                            ...
                            if (testen == true && mainForm.nickA1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickA1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 26:
                            ...
                            if (testen == true && mainForm.kamera1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.kamera1NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 27:
                            ...
                            if (testen == true && mainForm.compass1NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.compass1NumericUpDown.ForeColor = Color.Red;
                            }
                ...
                else
                {
                    switch (Convert.ToInt16(register.Command.Substring(9)))
                    {
                        case 1:
                            ...
                            if (testen == true && mainForm.rollProp2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollProp2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 2:
                            ...
                            if (testen == true && mainForm.rollInt2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollInt2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 3:
                            ...
                            if (testen == true && mainForm.rollDiff2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollDiff2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 4:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.rollLimit2NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.rollLimit2NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.rollLimit2NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.rollLimit2NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm2[3].Value = register.Value;
                        ...
                        case 5:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.rollIntLimit2NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.rollIntLimit2NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.rollIntLimit2NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.rollIntLimit2NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm2[4].Value = register.Value;
                        ...
                        case 6:
                            ...
                            if (testen == true && mainForm.nickProp2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickProp2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 7:
                            ...
                            if (testen == true && mainForm.nickInt2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickInt2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 8:
                            ...
                            if (testen == true && mainForm.nickDiff2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickDiff2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 9:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.nickLimit2NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.nickLimit2NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.nickLimit2NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.nickLimit2NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm2[8].Value = register.Value;
                        ...
                        case 10:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.nickIntLimit2NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.nickIntLimit2NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.nickIntLimit2NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.nickIntLimit2NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm2[9].Value = register.Value;
                        ...
                        case 11:
                            ...
                            if (testen == true && mainForm.gierProp2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierProp2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 12:
                            ...
                            if (testen == true && mainForm.gierInt2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierInt2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 13:
                            ...
                            if (testen == true && mainForm.gierDiff2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierDiff2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 14:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.gierLimit2NumericUpDown.ForeColor = Color.Red;
                                parameterForm2[13].Value = register.Value;
                            }
                            else
                            {
                                mainForm.gierLimit2NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.gierLimit2NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.gierLimit2NumericUpDown.ForeColor = Color.Red;
                                }
                        ...
                        case 15:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.gierIntLimit2NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.gierIntLimit2NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.gierIntLimit2NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.gierIntLimit2NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm2[14].Value = register.Value;
                        ...
                        case 16:
                            ...
                            {
                                mainForm.bit02CheckBox.ForeColor = Color.Red;
                                mainForm.bit12CheckBox.ForeColor = Color.Red;
                                mainForm.bit22CheckBox.ForeColor = Color.Red;
                                mainForm.bit32CheckBox.ForeColor = Color.Red;
                                mainForm.bit42CheckBox.ForeColor = Color.Red;
                            }
                            parameterForm2[15].Value = register.Value;
                            break;
                        case 17:
                            mainForm.impulseAusgabe2NumericUpDown.ForeColor = farbeElement;
                            if (testen == true && mainForm.impulseAusgabe2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.impulseAusgabe2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 18:
                            ...
                            if (testen == true && mainForm.akku2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.akku2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 19:
                            ...
                            if (testen == true && mainForm.rollMa2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollMa2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 20:
                            ...
                            if (testen == true && mainForm.nickMa2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickMa2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 21:
                            ...
                            if (testen == true && mainForm.gierMa2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierMa2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 22:
                            ...
                            if (testen == true && mainForm.gierA2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.gierA2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 23:
                            if (Convert.ToInt16(register.Value) == 0)
                            {
                                ...
                                mainForm.leerlaufgas2NumericUpDown.ForeColor = Color.Red;
                            }
                            else
                            {
                                mainForm.leerlaufgas2NumericUpDown.ForeColor = farbeElement;
                                if (testen == true && mainForm.leerlaufgas2NumericUpDown.Value != Convert.ToInt16(register.Value))
                                {
                                    mainForm.leerlaufgas2NumericUpDown.ForeColor = Color.Red;
                                }
                                parameterForm2[22].Value = register.Value;
                        ...
                        case 24:
                            ...
                            if (testen == true && mainForm.rollA2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.rollA2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 25:
                            ...
                            if (testen == true && mainForm.nickA2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.nickA2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 26:
                            ...
                            if (testen == true && mainForm.kamera2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.kamera2NumericUpDown.ForeColor = Color.Red;
                            }
                        ...
                        case 27:
                            ...
                            if (testen == true && mainForm.compass2NumericUpDown.Value != Convert.ToInt16(register.Value))
                            {
                                mainForm.compass2NumericUpDown.ForeColor = Color.Red;
                            }
