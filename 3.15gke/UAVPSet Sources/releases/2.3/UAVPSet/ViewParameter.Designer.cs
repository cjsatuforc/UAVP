namespace UAVP.UAVPSet
{
    partial class ViewParameter
    {
        ...
        private void InitializeComponent()
        {
            ...
            // set1Label
            // 
            this.set1Label.AccessibleDescription = null;
            this.set1Label.AccessibleName = null;
            resources.ApplyResources(this.set1Label, "set1Label");
            this.set1Label.Font = null;
            this.set1Label.Name = "set1Label";
            // 
            // set2Label
            // 
            this.set2Label.AccessibleDescription = null;
            this.set2Label.AccessibleName = null;
            resources.ApplyResources(this.set2Label, "set2Label");
            this.set2Label.Font = null;
            this.set2Label.Name = "set2Label";
            // 
            // set1TextBox
            // 
            this.set1TextBox.AccessibleDescription = null;
            this.set1TextBox.AccessibleName = null;
            resources.ApplyResources(this.set1TextBox, "set1TextBox");
            this.set1TextBox.BackgroundImage = null;
            this.set1TextBox.Font = null;
            this.set1TextBox.Name = "set1TextBox";
            // 
            // set2TextBox
            // 
            this.set2TextBox.AccessibleDescription = null;
            this.set2TextBox.AccessibleName = null;
            resources.ApplyResources(this.set2TextBox, "set2TextBox");
            this.set2TextBox.BackgroundImage = null;
            this.set2TextBox.Font = null;
            this.set2TextBox.Name = "set2TextBox";
            // 
            // set1Button
            // 
            this.set1Button.AccessibleDescription = null;
            this.set1Button.AccessibleName = null;
            resources.ApplyResources(this.set1Button, "set1Button");
            this.set1Button.BackgroundImage = null;
            this.set1Button.Font = null;
            ...
            // set2Button
            // 
            this.set2Button.AccessibleDescription = null;
            this.set2Button.AccessibleName = null;
            resources.ApplyResources(this.set2Button, "set2Button");
            this.set2Button.BackgroundImage = null;
            this.set2Button.Font = null;
