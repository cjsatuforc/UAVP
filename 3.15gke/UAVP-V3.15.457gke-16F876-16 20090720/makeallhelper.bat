...
%LEXE% %LCMD% %F% /o UAVP-V3.15.457gke-16F876-16_%C%%D%%T%%G%%R%%E%.hex >> log.lst 


if %ERRORLEVEL% == 1 goto FAILED

echo compiled - UAVP-V3.15.457gke-16F876-16_%C%%D%%T%%G%%R%%E%.hex
echo compiled - UAVP-V3.15.457gke-16F876-16_%C%%D%%T%%G%%R%%E%.hex >> gen.lst
call makeclean.bat
goto FINISH

:FAILED
echo failed - UAVP-V3.15.457gke-16F876-16_%C%%D%%T%%G%%R%%E%.hex
echo failed - UAVP-V3.15.457gke-16F876-16_%C%%D%%T%%G%%R%%E%.hex >> gen.lst
