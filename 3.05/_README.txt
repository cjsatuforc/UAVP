...
- CC5X Compiler, at least version 3.3
  free download at http.//wwww.bknd.com
- The free UAVPset.exe software (for Windows)

Follow instuctions found in the CC5X package on how
to integrate this language toolset into MPLAB

Create a project, which creates a project directory
for the source files.
Put the contents of this ZIP file into that directory.

Add all .c-Files to the "Source Files" tag
Add all .h-Files to the "Header Files" tag
Add all .lkr-Files to the "Linker Scripts" tag
